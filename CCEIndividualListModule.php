                              ...
                              implements ModuleListInterface, ModuleCustomInterface // , RequestHandlerInterface
{
                    ...
                    if ($show === 'indi') {
                        if ($this->families) {
                            echo view('lists/families-table', [
                                ...
                                'families' => $this->families($tree, $surname, array_keys($surns ?? []), $falpha, $show_marnm === 'yes'),   // EW.H - MOD ... we have allready the array of surnames
                                'tree'     => $tree,
                            ]);
                        } else {
                            echo view('lists/individuals-table', [
                                ...
                                'individuals' => $this->individuals($tree, $surname, array_keys($surns ?? []), $falpha, $show_marnm === 'yes', false),   // EW.H - MOD ... we have allready the array of surnames
                                'sosa'        => false,
                                'tree'        => $tree,
                            ]);
                        }
    ...
    public function allSurnames(Tree $tree, bool $marnm, bool $fams): array
    {
     ...
     * @return array<int>
     */
    public function surnameInitials(array $all_surnames): array
    {
